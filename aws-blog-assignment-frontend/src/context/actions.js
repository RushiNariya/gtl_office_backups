...
export const SET_FILTERED_BLOGS = 'SET_FILTERED_BLOGS';
export const CLEAR_FILTERED_BLOGS = 'CLEAR_FILTERED_BLOGS';
...
export const setFilteredBlogsAction = (payload) => ({
  type: SET_FILTERED_BLOGS,
  payload,
});

export const clearFilteredBlogsAction = () => ({
  type: CLEAR_FILTERED_BLOGS,
});
